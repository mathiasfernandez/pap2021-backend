...
public interface IcEspectaculo {
	...
	public void setFuncion(String nomEspectaculo, String nomFuncion, Date fecha, List<String> invitados) throws FuncionYaExisteExcepcion; // da de alta una funcion
	...
	public void confirmarAltaEspectaculo(String nombreEsp, String descripcion, int duracion, int minEspectadores, int maxEspectadores,
			String url, float costo, Date fechaRegistro,String pla, String art,String imagen) throws EspectaculoRepetidoExepcion;
